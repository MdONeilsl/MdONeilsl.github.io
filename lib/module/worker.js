...
export const merge_normal_map_worker = async (base_data, add_data, mask_data, width, height) => {
    ...
    return run_worker_task(
        '../worker/normal_merger.js',
        { base_data, add_data, mask_data, width, height }
    );
}

export const scale_image_worker = async (src, width, height, target_width, target_height, options = {}) => {
    //console.log(`worker.js`, src, width, height, target_width, target_height, options);
    return run_worker_task(
        '../worker/image_scaler.js',
